...
- Open the repository in Google Colab
    ...
    - Click on **File** > **Save a copy in Drive** to save a copy of the notebook in your Google Drive
    - Click on **Runtime** > **Change runtime type** and select **GPU** as the hardware accelerator
- Alternatively, you can use the "Open in Colab" button in this notebook to open them in Google Colab.
---
